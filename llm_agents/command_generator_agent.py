...
def generate_script(package, current_version, updated_version, os_type):
    ...
    prompt = PromptTemplate(
        ...
        template="""
You are a system administrator assistant. Generate a script to update the package '{package}' fromv version '{current_version}' to version '{updated_version}' on a '{os_type}' system.

Include:
- Any dependencies that need to be updated or installed
- Download commands for downloading the package from the web if required
